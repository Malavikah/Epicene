...
public class Customjob extends BaseAdapter{
    ...
    public Customjob(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_customjob,null);
