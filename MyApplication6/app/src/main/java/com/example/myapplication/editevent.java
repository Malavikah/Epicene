...
e1.setText(getIntent().getStringExtra("ename"));
		e2.setText(getIntent().getStringExtra("edes"));
		e3.setText(getIntent().getStringExtra("evnu"));
		e4.setText(getIntent().getStringExtra("edate"));
		e5.setText(getIntent().getStringExtra("etime"));
	     ...
	     b1.setOnClickListener (new View.OnClickListener() {
			...
			public void onClick(View arg0) {
                ...
                RequestQueue queue = Volley.newRequestQueue(editevent.this);
                String url ="http://"+sp.getString("ip","")+":5000/editevent";
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, url,new Response.Listener<String>() {
                    ...
                    protected Map<String, String> getParams()
                    {
                        ...
                        params.put("id",getIntent().getStringExtra("eid"));
