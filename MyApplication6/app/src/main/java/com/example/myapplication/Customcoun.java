...
public class Customcoun extends BaseAdapter{
    ...
    public Customcoun(Context applicationContext, ArrayList<String> a, ArrayList<String> b, ArrayList<String> c) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null)
        {
            ...
            gridView=inflator.inflate(R.layout.activity_customcoun,null);
